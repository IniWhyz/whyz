...
<body>
    ...
    <fieldset>
        <center>
            <br>
            <div class="TITLE">
                <font face='Maiandra GD' size='6'>DATA MATA PELAJARAN</font>
            </div>
            <br>
                ...
                <table border="1">
                    ...
                    <?php while ($data = mysqli_fetch_array($search_result)) : ?>
                        ...
                        <tr>
                            ...
                            <td><font face='Maiandra GD'><?php echo $data["mapel"]; ?></td>
                            <td><font face='Maiandra GD'><?php echo $data["id_jurusan"]; ?></td>

                            <td>
                                <font face='comic sans MS'>
                                    <a href="mata_pelajaran_editV2.php?id=<?php echo $data['id']; ?>"> Edit </a>
                            </td>
                            <td>
                                <font face='comic sans MS'>
                                    <a href="mata_pelajaran_delete.php?id=<?php echo $data['id']; ?>"> Delete </a>
                            </td>
                            </font>
                        </tr>
    </fieldset>
